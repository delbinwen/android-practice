...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent explicitActivityIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		chooserIntent.setFlags(Intent.FLAG_DEBUG_LOG_RESOLUTION);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
			mUserTextView.setText(data.getStringExtra("USER_INPUT"));
		}
